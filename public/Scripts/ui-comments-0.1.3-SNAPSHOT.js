  ...
  function ($compile, commentsConfig, $controller, $exceptionHandler, $timeout) {
    return {
      ...
      link: function (scope, elem, attr, ctrls) {
        ...
        var postCommentList = false, compiled, sub = $compile('<div comments child-comments="true" ' + 'comment-data="comment.postCommentList"></div>'), transclude;
        ...
        function update(data) {
          ...
          if (data.length > 0 && !postCommentList) {
          ...
          } else if (!data.length && postCommentList) {
              postCommentList = false;
        ...
        scope.$watch('comment', function (newval) {
          update(scope.comment.postCommentList);
        }, true);
      }
    };
  }
