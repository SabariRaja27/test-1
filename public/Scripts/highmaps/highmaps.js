...
{}; if ( c.d ) b.toD = c.d, c.d = 1; e.stop(); c.opacity !== q && b.attr && ( c.opacity += "px" ); b.hasAnim = 1; e.animate( c, d )
    ...
    }, labels: { style: { position: "absolute", color: "#3E576F"} }, legend: { enabled: !0, align: "center", layout: "horizontal", labelFormatter: function () { return this.name }, borderColor: "#909090", borderRadius: 0, navigation: { activeColor: "#274b6d", inactiveColor: "#CCC" }, shadow: !1, itemStyle: { color: "#333333", fontSize: "12px", fontWeight: "bold" },
    ...
    }, loading: { labelStyle: { fontWeight: "bold", position: "relative", top: "45%" }, style: { position: "absolute", backgroundColor: "white", opacity: 0.5, textAlign: "center"} }, tooltip: { enabled: !0, animation: ca, backgroundColor: "rgba(249, 249, 249, .85)", borderWidth: 1, borderRadius: 3, dateTimeLabelFormats: { millisecond: "%A, %b %e, %H:%M:%S.%L",
...
D( c[3] ), parseFloat( c[4], 10 )] : ( c = Qb.exec( a ) ) ? b = [D( c[1], 16 ), D( c[2], 16 ), D( c[3], 16 ), 1] : ( c = Rb.exec( a ) ) && ( b = [D( c[1] ), D( c[2] ), D( c[3] ), 1] )
    } )( a ); return { get: function ( c ) { var f; d ? ( f = A( a ), f.stops = [].concat( f.stops ), m( d, function ( a, b ) { f.stops[b] = [f.stops[b][0], a.get( c )] } ) ) : f = b && !isNaN( b[0] ) ? c === "rgb" ? "rgb(" + b[0] + "," + b[1] + "," + b[2] + ")" : c === "a" ? b[3] : "rgba(" + b.join( "," ) + ")" : a; return f }, brighten: function ( a )
    {
...
{
    var b = this; m( "x,y,r,start,end,width,height,innerR,anchorX,anchorY".split( "," ), function ( c ) { b[c] = o( a[c], b[c] ) } ); b.attr( { d: b.renderer.symbols[b.symbolName]( b.x,
...
{
    a && this.element.namespaceURI === za ? this.element.removeAttribute( "visibility" ) : this.attr( { visibility: a ? "inherit" :
"visible"
    } ); return this
...
arguments )
}; ia.prototype = { Element: P, init: function ( a, b, c, d, e )
{
...
a.textStr ); a.rotation = x
    ...
    {
        var j = this.label( a, b, c, i, null, null, null, null, "button" ), k = 0, l, n, p, v, t, m, a = { x1: 0, y1: 0, x2: 0, y2: 1 }, e = A( { "stroke-width": 1, stroke: "#CCCCCC", fill: { linearGradient: a, stops: [[0, "#FEFEFE"], [1, "#F6F6F6"]] }, r: 2, padding: 5, style: { color: "black"} }, e ); p = e.style; delete e.style; f = A( e, { stroke: "#68A", fill: { linearGradient: a,
            stops: [[0, "#FFF"], [1, "#ACF"]]
        }
...
}; Na = ia; s( P.prototype, { htmlCss: function ( a ) { var b = this.element; if ( b = a && b.tagName === "SPAN" && a.width ) delete a.width, this.textWidth = b, this.updateTransform(); if ( a && a.textOverflow === "ellipsis" ) a.whiteSpace = "nowrap", a.overflow = "hidden"; this.styles = s( this.styles, a ); F( this.element, a ); return this }, htmlGetBBox: function ()
{
    var a =
...
} ); s( ia.prototype, { html: function ( a, b, c )
{
...
d.ySetter = d.alignSetter = d.rotationSetter = function ( a, b ) { b === "align" && ( b = "textAlign" ); d[b] = a; d.htmlUpdateTransform() }; d.attr( { text: a, x: x( b ), y: x( c ) } ).css( { position: "absolute", fontFamily: this.style.fontFamily, fontSize: this.style.fontSize } ); e.style.whiteSpace = "nowrap"; d.css = d.htmlCss; if ( f.isSVG ) d.add = function ( a )
{
    var b, c = f.box.parentNode, j = []; if ( this.parentGroup = a )
    {
        if ( b = a.div, !b )
        {
            ...
            {
                var d; b = a.div = a.div || $( Fa, { className: H( a.element, "class" ) }, { position: "absolute",
...
} ); var Wa; if ( !ca && !ga ) E = { init: function ( a, b )
{
...
{
    var e = this.createElement(), f = ea( a ); return s( e, { members: [], count: 0, left: ( f ? a.x : a ) + 1, top: ( f ? a.y : b ) + 1, width: ( f ? a.width : c ) - 1, height: ( f ? a.height : d ) - 1, getCSS: function ( a )
    {
        var b = a.element, c = b.nodeName, a = a.inverted, d = this.top - ( c === "shape" ? b.offsetTop : 0 ), e = this.left, b = e + this.width, f = d + this.height, d = { clip: "rect(" + x( a ? e : d ) + "px," +
...
{
    var c = this, d = b.style, e = a.tagName === "IMG" && a.style; F( a, { flip: "x",
        left: D( d.width ) - ( e ? D( e.top ) : 1 ), top: D( d.height ) - ( e ? D( e.left ) : 1 ), rotation: -90
    } ); m( a.childNodes, function ( b ) { c.invertChild( b, a ) } )
}, symbols: { arc: function ( a, b, c, d, e ) { var f = e.start, g = e.end, h = e.r || c || d, c = e.innerR, d = ka( f ), i = oa( f ), j = ka( g ), k = oa( g ); if ( g - f === 0 ) return ["x"]; f = ["wa", a - h, b - h, a + h, b + h, a + h * d, b + h * i, a + h * j, b + h * k]; e.open && !c && f.push( "e", "M", a, b ); f.push( "at", a - c, b - c, a + c, b + c, a + c * j, b + c * k, a + c * d, b + c * i, "x", "e" ); f.isArc = !0; return f }, circle: function ( a, b, c, d, e )
{
...
{}, Gb = function () { function a() { var a = b.length, d; for ( d = 0; d < a; d++ ) b[d](); b = [] } var b = []; return { push: function ( c, d ) { b.length === 0 && Mb( d, a ); b.push( c ) } } } (), Na = E; Ma.prototype = { addLabel: function ()
{
    var a = this.axis, b = a.options, c = a.chart, d = a.categories, e = a.names, f = this.pos, g = b.labels, h = a.tickPositions, i = f === h[0], j = f === h[h.length - 1], e = d ? o( d[f], e[f], f ) : f, d = this.label, h = h.info, k; a.isDatetimeAxis && h && ( k = b.dateTimeLabelFormats[h.higherRanks[f] || h.unitName] ); this.isFirst = i; this.isLast = j; b = a.labelFormatter.call( { axis: a,
...
}; var X = z.Axis = function () { this.init.apply( this, arguments ) }; X.prototype = { defaultOptions: { dateTimeLabelFormats: { millisecond: "%H:%M:%S.%L", second: "%H:%M:%S", minute: "%H:%M",
...
}; var Hb = z.Tooltip = function () { this.init.apply( this, arguments ) }; Hb.prototype = { init: function ( a, b )
{
...
}; s( z.Pointer.prototype, { pinchTranslate: function ( a, b, c, d, e, f )
{
...
{
    var c = this.pages, d = c.length, e = this.currentPage + a, f = this.clipHeight, g = this.options.navigation, h = g.activeColor, g = g.inactiveColor, i = this.pager, j = this.padding; e > d && ( e = d ); if ( e > 0 ) b !== q && ( ha = o( b, this.chart.animation ) ), this.nav.attr( { translateX: j,
...
}; var Ya = z.LegendSymbolMixin = { drawRectangle: function ( a, b )
{
...
}; ( /Trident\/7\.0/.test( ya ) || Ha ) && da( Xa.prototype, "positionItem", function ( a, b ) { var c = this, d = function () { b._legendItemPos && a.call( c, b ) }; d(); setTimeout( d ) } ); var ma = z.Chart = function () { this.init.apply( this, arguments ) }; ma.prototype = { callbacks: [], init: function ( a, b )
{
...
{
    var d = this, e, f, g; d.isResizing += 1; g = function () { d && L( d, "endResize", null, function () { d.isResizing -= 1 } ) }; ha = o( c, d.animation ); d.oldChartHeight = d.chartHeight; d.oldChartWidth = d.chartWidth; if ( r( a ) ) d.chartWidth = e = w( 0, x( a ) ), d.hasUserSize = !!e; if ( r( b ) ) d.chartHeight = f = w( 0, x( b ) ); ( ha ? fb : F )( d.container, { width: e +
"px", height: f + "px"
...
}; var Z = function () { }; Z.prototype = { init: function ( a, b, c )
{
...
va( b, this ), !b.length ) ) a.hoverPoints = null; if ( this === a.hoverPoint ) this.onMouseOut(); if ( this.graphic || this.dataLabel ) Y( this ), this.destroyElements(); this.legendItem && a.legend.destroyItem( this ); for ( c in this ) this[c] = null
    ...
    {
        return { x: this.category, y: this.y, key: this.name || this.category, series: this.series, point: this,
...
}; var R = z.Series = function () { }; R.prototype = { isCartesian: !0, type: "line", pointClass: Z, sorted: !0, requireSorting: !0, pointAttrToOptions: { stroke: "lineColor", "stroke-width": "lineWidth", fill: "fillColor", r: "radius" }, axisTypes: ["xAxis", "yAxis"], colorCounter: 0, parallelArrays: ["x", "y"], init: function ( a, b )
{
...
{
    var b = this.chart, c = this.options.animation, d; if ( c && !ea( c ) ) c = U[this.type].animation; a ? this.setClip( c ) : ( d = this.sharedClipKey, ( a = b[d] ) && a.animate( { width: b.plotSizeX }, c ), b[d + "m"] && b[d + "m"].animate( { width: b.plotSizeX +
99
    }, c ), this.animate = null )
...
{
    e = o( f, n ? p ? b.plotWidth : 0 : p ? 0 : l.toPixels( l.min ) ); f = x( l.toPixels( o( d.value, l.max ), !0 ) ); e = l.isXAxis ? e > f ? f : e : e < f ? f : e; v && ( e = f = l.toPixels( l.max ) ); if ( l.isXAxis ) { if ( h = { x: n ? f : e, y: 0, width: Math.abs( e - f ), height: k }, !p ) h.x = b.plotHeight - h.x } else if ( h = { x: 0, y: n ? e : f, width: k, height: Math.abs( e -
f )
...
}, kdDimensions: 1, kdTree: null, kdAxisArray: ["clientX", "plotY"], kdComparer: "distX", searchPoint: function ( a ) { var b = this.xAxis, c = this.yAxis, d = this.chart.inverted; return this.searchKDTree( { clientX: d ? b.len - a.chartY + b.pos : a.chartX - b.pos, plotY: d ? c.len - a.chartX + c.pos : a.chartY - c.pos } ) }, buildKDTree: function ()
{
    function a( b, d, g )
    {
        var h, i; if ( i = b && b.length ) return h = c.kdAxisArray[d % g], b.sort( function ( a, b ) { return a[h] - b[h] } ), i = Math.floor( i / 2 ), { point: b[i],
...
}, searchKDTree: function ( a )
{
    function b( a, h, i, j )
    {
        var k = h.point, l = c.kdAxisArray[i % j], n, p = k; n = r( a[e] ) && r( k[e] ) ? Math.pow( a[e] - k[e], 2 ) : null; var m = r( a[f] ) && r( k[f] ) ? Math.pow( a[f] - k[f], 2 ) : null, o = ( n || 0 ) + ( m || 0 ); n = { distX: r( n ) ? Math.sqrt( n ) : Number.MAX_VALUE, distY: r( m ) ? Math.sqrt( m ) : Number.MAX_VALUE, distR: r( o ) ?
...
}; s( ma.prototype, { addSeries: function ( a, b, c )
{
...
} ); s( Z.prototype, { update: function ( a, b, c, d )
{
    function e()
    {
        f.applyOptions( a );
...
} ); s( R.prototype, { addPoint: function ( a, b, c, d )
{
...
} ); s( X.prototype, { update: function ( a, b ) { var c = this.chart, a = c.options[this.coll][this.options.index] = A( this.userOptions, a ); this.destroy( !0 ); this._addedPlotLB = q; this.init( c, s( a, { events: q } ) ); c.isDirtyBox = !0; o( b, !0 ) && c.redraw() }, remove: function ( a ) { for ( var b = this.chart, c = this.coll, d = this.series, e = d.length; e--; ) d[e] && d[e].remove( !1 ); va( b.axes, this ); va( b[c], this ); b.options[c].splice( this.options.index, 1 ); m( b[c], function ( a, b ) { a.options.index = b } ); this.destroy(); b.isDirtyBox = !0; o( a, !0 ) && b.redraw() },
...
} ); u.column = E; U.scatter = A( ta, { lineWidth: 0, marker: { enabled: !0 }, tooltip: { headerFormat: '<span style="color:{series.color}">\u25CF</span> <span style="font-size: 10px;"> {series.name}</span><br/>',
...
{
    var f = this.chart, g = f.inverted, h = o( a.plotX, -999 ), i = o( a.plotY, -999 ), j = b.getBBox(), k = f.renderer.fontMetrics( c.style.fontSize ).b, l = this.visible && ( a.series.forceDL || f.isInsidePlot( h, x( i ), g ) || d && f.isInsidePlot( h, g ? d.x + 1 : d.y + d.height - 1, g ) ); if ( l ) d = s( { x: g ? f.plotWidth - i : h, y: x( g ? f.plotHeight - h : i ),
        width: 0, height: 0
...
{
    var f = this.chart.inverted, g = a.series, h = a.dlBox || a.shapeArgs, i = a.below || a.plotY > o( this.translatedThreshold, g.yAxis.len ), j = o( c.inside, !!this.options.stacking ); if ( h && ( d = A( h ), f && ( d = { x: g.yAxis.len - d.y - d.height, y: g.xAxis.len - d.x - d.width, width: d.height,
        height: d.width
...
}, gb = document.documentElement.style.vectorEffect !== void 0; U.map = A( U.scatter, { allAreas: !0, animation: !1, nullColor: "#F8F8F8", borderColor: "silver",
...
} ); var Ib = aa( Z, { applyOptions: function ( a, b )
{
...
{
    var a = this, b = +new Ga, c = V( a.color ), d = V( a.pointAttr.hover.fill ), e = a.series.options.states.normal.animation, f = e && ( e.duration || 500 ), g; if ( f && c.rgba.length === 4 && d.rgba.length ===
...
A( Ia, { type: "map", pointClass: Ib, supportsDrilldown: !0, getExtremesFromAll: !0, useMapGeometry: !0, forceDL: !0, searchPoint: T, preserveAspectRatio: !0, getBox: function ( a )
{
...
} ); s( Aa.prototype, { onContainerDblClick: function ( a )
{
...
} ); u.mappoint = aa( u.scatter, { type: "mappoint", forceDL: !0, pointClass: aa( Z, { applyOptions: function ( a, b ) { var c = Z.prototype.applyOptions.call( this, a, b ); a.lat !== void 0 && a.lon !== void 0 && ( c = s( c, this.series.chart.fromLatLonToPoint( c ) ) ); return c } } ) } ); U.bubble = A( U.scatter, { dataLabels: { formatter: function () { return this.point.z }, inside: !0, verticalAlign: "middle" }, marker: { lineColor: null, lineWidth: 1 }, minSize: 8, maxSize: "20%", states: { hover: { halo: { size: 5}} }, tooltip: { pointFormat: "({point.x}, {point.y}), Size: {point.z}" },
    turboThreshold: 0, zThreshold: 0, zoneAxis: "z"
} ); var Tb = aa( Z, { haloPath: function () { return Z.prototype.haloPath.call( this, this.shapeArgs.r + this.series.options.states.hover.halo.size ) }, ttBelow: !1 } ); u.bubble = aa( u.scatter, { type: "bubble", pointClass: Tb, pointArrayMap: ["y", "z"], parallelArrays: ["x", "y", "z"], trackerGroups: ["group", "dataLabelsGroup"], bubblePadding: !0, zoneAxis: "z", pointAttrToOptions: { stroke: "lineColor", "stroke-width": "lineWidth", fill: "fillColor" }, applyOpacity: function ( a )
{
...
}; if ( u.bubble ) U.mapbubble = A( U.bubble, { animationLimit: 500, tooltip: { pointFormat: "{point.name}: {point.z}"} } ), u.mapbubble = aa( u.bubble, { pointClass: aa( Z, { applyOptions: function ( a, b ) { var c; a.lat !== void 0 && a.lon !== void 0 ? ( c = Z.prototype.applyOptions.call( this, a, b ), c = s( c, this.series.chart.fromLatLonToPoint( c ) ) ) : c = Ib.prototype.applyOptions.call( this, a, b ); return c },
    ttBelow: !1
...
{
    if ( window.proj4 === void 0 ) return ba( 21 ), { x: 0, y: null }; var c = window.proj4( b.crs, [a.lon, a.lat] ), d = b.cosAngle || b.rotation && Math.cos( b.rotation ), e = b.sinAngle || b.rotation && Math.sin( b.rotation ), c = b.rotation ? [c[0] * d + c[1] * e, -c[0] * e + c[1] * d] : c; return { x: ( ( c[0] - ( b.xoffset || 0 ) ) * ( b.scale || 1 ) + ( b.xpan || 0 ) ) *
...
{
    var c = { endOnTick: !1, gridLineWidth: 0, lineWidth: 0,
...
}; I.plotOptions.heatmap = A( I.plotOptions.scatter, { animation: !1, borderWidth: 0, nullColor: "#F8F8F8", dataLabels: { formatter: function () { return this.point.value }, inside: !0, verticalAlign: "middle", crop: !1, overflow: !1, padding: 0 }, marker: null, pointRange: null, tooltip: { pointFormat: "{point.x}, {point.y}: {point.value}<br/>" },
    states: { normal: { animation: !0 }, hover: { halo: !1, brightness: 0.2}}
} ); u.heatmap = aa( u.scatter, A( Ia, { type: "heatmap", pointArrayMap: ["y", "value"], hasPointSpecificOptions: !0, supportsDrilldown: !0, getExtremesFromAll: !0, init: function () { var a; u.scatter.prototype.init.apply( this, arguments ); a = this.options; this.pointRange = a.pointRange = o( a.pointRange, a.colsize || 1 ); this.yAxis.axisPointRange = a.rowsize || 1 }, translate: function ()
{
...
} ) ); Ia = z.TrackerMixin = { drawTrackerPoint: function ()
{
...
}; if ( u.column ) E.prototype.drawTracker = Ia.drawTrackerPoint; if ( u.pie ) u.pie.prototype.drawTracker = Ia.drawTrackerPoint; if ( u.scatter ) ta.prototype.drawTracker = Ia.drawTrackerPoint; s( Xa.prototype, { setItemEvents: function ( a, b, c, d, e )
{
    var f = this; ( c ? b : a.legendGroup ).on( "mouseover", function () { a.setState( "hover" ); b.css( f.options.itemHoverStyle ) } ).on( "mouseout",
function () { b.css( a.visible ? d : e ); a.setState() } ).on( "click", function ( b ) { var c = function () { a.setVisible() }, b = { browserEvent: b }; a.firePointEvent ? a.firePointEvent( "legendItemClick", b, c ) : L( a, "legendItemClick", b, c ) } )
...
[1, 0] : [1], function ( b ) { var d = a[b ? "chartX" : "chartY"], h = c[b ? "xAxis" : "yAxis"][0], i = c[b ? "mouseDownX" : "mouseDownY"], j = ( h.pointRange || 0 ) / 2, k = h.getExtremes(), l = h.toValue( i - d, !0 ) + j, j = h.toValue( i + c[b ? "plotWidth" : "plotHeight"] - d, !0 ) - j, i = i > d; if ( h.series.length && ( i || l > N( k.dataMin, k.min ) ) && ( !i || j < w( k.dataMax, k.max ) ) ) h.setExtremes( l, j, !1, !1, { trigger: "pan" } ), e = !0; c[b ? "mouseDownX" : "mouseDownY"] = d } ); e && c.redraw( !1 ); F( c.container, { cursor: "move" } )
    ...
    } ); s( Z.prototype, { select: function ( a, b )
    {
...
o.attr( { d: [] } ); this.state = a
    ...
    } ); s( R.prototype, { onMouseOver: function () { var a = this.chart, b = a.hoverSeries; if ( b && b !== this ) b.onMouseOut(); this.options.events.mouseOver && L( this, "mouseOver" ); this.setState( "hover" ); a.hoverSeries = this }, onMouseOut: function ()
    {
...
!1 )
    ...
    } ); s( z, { Color: V, Point: Z, Tick: Ma, Renderer: Na, SVGElement: P, SVGRenderer: ia, arrayMin: Ra, arrayMax: Ea, charts: W, dateFormat: Ka, error: ba, format: Ja, pathAnim: ob, getOptions: function () { return I }, hasBidiBug: Jb, isTouchDevice: Eb,
