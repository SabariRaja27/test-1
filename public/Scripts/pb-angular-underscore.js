...
angular.module('pb.angular.underscore', ['ng']).
    provider('underscore', function () {
...
//     Underscore may be freely distributed under the MIT license.
        (function () {
            ...
            var parserMinErr = angular.$$minErr('parser');
            ...
            _.bind = function (func, context) {
                ...
                if (!_.isFunction(func)) throw parserMinErr('Bind Error', 'Bind must be called on a function');
                var args = slice.call(arguments, 2);
                var bound = function () {
            ...
            _.bindAll = function (obj) {
                ...
                if (length <= 1) throw parserMinErr('BindAll', 'bindAll must be passed function names');
                for (i = 1; i < length; i++) {
                    key = arguments[i];
            ...
            _.template = function (text, settings, oldSettings) {
                ...
                try {
                    ...
                    e.source = source;
                    throw parserMinErr('Event Error', 'Event Error');
                }
