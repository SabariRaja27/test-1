...
reachApp.directive('vmSelect2',['$timeout', function ($timeout) {
    return {
        restict: 'E',
        ...
        templateUrl: 'app/common/view/directiveTemplates/select2/select2.html',
        link: function (scope, element, attrs, controller) {
            ...
            scope.onChangeEvent = function (obj, id) {
               scope.$emit(id + '_Changed', obj);
            }
        }
    };
